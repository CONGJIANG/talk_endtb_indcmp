...
- Apply that same model to each patient in ${\color{#6b72ff}{\textbf{Trial 1}}}$ to get their predicted outcome under treatment *a*.
...
- Apply that same model to each patient in ${\color{#6b72ff}{\textbf{Trial 1}}}$ to get their predicted outcome under treatment *b*.
...
* **4 (Indirect):** requires transportability for (1) controls (given country $V$), and (2) treatments (given $L$)
:::
