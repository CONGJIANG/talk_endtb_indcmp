...
::: {style="font-size: 85%;"}
  ...
  - We compare four strategies by combining ideas from *transportability, target trial emulation, and IPD meta-analysis* (Hernán & Robins, 2016) (Riley et al., 2010).
...
| **(2) Target Trial Emulation Approach** | Combine treatment arms by..., analyze as an observational study | $\Omega$ (Pooled) |
...
::: {style="font-size: 85%;"}
Due to $\Omega = \Omega_{\text{TB-PRACTECAL}} \cup \Omega_{\text{endTB}},$ we use transportability.
...
$\color{#E69F00}{\mathbb{P}_{\Omega}(S=1)}$ is the marginal probability of being selected into trial 1 within the target population.
:::
...
3. **Causal machine learning estimator** (Appendix)
...
| Method                      | Uses randomization | Uses all arms | Intuitive to clinicians | Statistically efficient | More Assumption | Requires transportability |
| --------------------------- | :----------------: | :-----------: | :---------------------: | :-----------: | :---------------------: | :-----------------------: |
| **1: Traditional Approach**      |          ✔          |       ✔        |            ✔            |       △       |            △            |             ✖             |
| **2: Trial Emulation**      |          ✖         |       ✖       |            ✔            |       △       |            △            |             ✖             |
| **3: Pooled-IPD Direct**   |          ✔         |       ✔       |            ✔            |       ✔       |            ✔            |             ✔             |
| **4: Pooled-IPD Indirect** |          ✔         |       ✔       |            △            |       ✔       |            ✔            |             ✔             |
:::
