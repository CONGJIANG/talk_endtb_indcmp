...
::: {style="font-size: 85%;"}
- **Transportability**  
  Prior work studies how to transport causal effects from multiple randomized trials to a **new target population** where experimental data may not be available  [@hernan2016] [@dahabreh2019extending]
:::
...
## Method (3): Indirect Method – decomposition for adjusting differing standard care
...
* **2:** requires equality of treatment effect in $\Omega_{trt}$ and $\Omega$
* **3:** requires transportability for

  * controls (given country $V$), and
  * treatments (given $L$)
* **4:** requires transportability of treatment effects given $L$
:::
...
| **2 Observational** | Uses **all treated units** across trials but may discard controls for the main contrast.         |
