...
::: {style="font-size: 85%;"}
Due to $\Omega = \Omega_{\text{TB-PRACTECAL}} \cup \Omega_{\text{endTB}},$ we use law of total expectation/probability to decompose $\Omega$ into each trial's population and then apply **transportability**.
:::
...
If we do not have within trial randomization, we need to measure all important patient characteristics ($L$s) to ensure **treatment assignment is unrelated to what outcomes would have been under different treatments**.
:::
